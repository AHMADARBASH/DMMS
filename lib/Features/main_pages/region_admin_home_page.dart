...
import 'package:dmms/Features/main_pages/widgets/region_admin/region_admin_dashboard.dart';
import 'package:dmms/Features/main_pages/widgets/region_admin/region_admin_drawer.dart';
...
class RegionAdminHomePage extends StatefulWidget {
  static const String routeName = '/RegionAdminHomePage';
  final AuthenticatedUser user;
  const RegionAdminHomePage({super.key, required this.user});

  @override
  State<RegionAdminHomePage> createState() => _RegionAdminHomePageState();
}

class _RegionAdminHomePageState extends State<RegionAdminHomePage> {
