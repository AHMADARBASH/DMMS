...
import 'package:dmms/Features/departments/presentation/pages/departments_page.dart';
import 'package:dmms/Features/vehicles/presentation/pages/vehicles_page.dart';
...
class BranchAdminDrawer extends StatelessWidget {
  final AuthenticatedUser user;
  const BranchAdminDrawer({super.key, required this.user});
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  leading:
                      Icon(FontAwesome5.car, color: context.appColors.primary),
                  title: Text(AppStrings.vehicles.tr()),
                  onTap: () {
                    context.pushNamed(VehiclesPage.routeName);
                  },
                ),
                ListTile(
                  leading: Icon(Icons.work, color: context.appColors.primary),
                  title: Text(AppStrings.departments.tr()),
                  onTap: () {
                    context.pushNamed(DepartmentsPage.routeName);
                  },
                ),
                ListTile(
                  leading:
