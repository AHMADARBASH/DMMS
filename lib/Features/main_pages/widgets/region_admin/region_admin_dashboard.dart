...
class RegionAdminDashboard extends StatelessWidget {
  const RegionAdminDashboard({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider<DashboardBloc>(
      lazy: false,
      create: (context) =>
          DashboardBloc()..add(DashboardEvent.getRegionAdminData()),
      child:
        ...
        if (state.errorResponse != null) {
          return ErrorRefreshWidget(
              onPressed: () {
                context
                    .read<DashboardBloc>()
                    .add(DashboardEvent.getRegionAdminData());
              },
              text:
              ...
              child: SingleChildScrollView(
                ...
                child: Column(spacing: AppSize.s10, children: [
                  Row(
                    ...
                    children: [
                      Text(AppStrings.regionAdminDashboard.tr()),
                    ],
                  ),
                  ChartCard(
